...
export declare const awsIntegrations: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "aws_integrations";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "aws_integrations";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
        ...
        roleArn: import("drizzle-orm/pg-core").PgColumn<{
            name: "role_arn";
            tableName: "aws_integrations";
            dataType: "string";
            columnType: "PgText";
...
export declare const awsInstances: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "aws_instances";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
        ...
        instanceType: import("drizzle-orm/pg-core").PgColumn<{
            name: "instance_type";
            tableName: "aws_instances";
            dataType: "string";
            columnType: "PgVarchar";
        ...
        publicIp: import("drizzle-orm/pg-core").PgColumn<{
            name: "public_ip";
            tableName: "aws_instances";
            dataType: "string";
            columnType: "PgVarchar";
        ...
        privateIp: import("drizzle-orm/pg-core").PgColumn<{
            name: "private_ip";
            tableName: "aws_instances";
            dataType: "string";
            columnType: "PgVarchar";
        ...
        publicDns: import("drizzle-orm/pg-core").PgColumn<{
            name: "public_dns";
            tableName: "aws_instances";
            dataType: "string";
            columnType: "PgText";
        ...
        privateDns: import("drizzle-orm/pg-core").PgColumn<{
            name: "private_dns";
            tableName: "aws_instances";
            dataType: "string";
            columnType: "PgText";
        ...
        vpcId: import("drizzle-orm/pg-core").PgColumn<{
            name: "vpc_id";
            tableName: "aws_instances";
            dataType: "string";
            columnType: "PgVarchar";
        ...
        subnetId: import("drizzle-orm/pg-core").PgColumn<{
            name: "subnet_id";
            tableName: "aws_instances";
            dataType: "string";
            columnType: "PgVarchar";
        ...
        securityGroups: import("drizzle-orm/pg-core").PgColumn<{
        ...
        launchTime: import("drizzle-orm/pg-core").PgColumn<{
            name: "launch_time";
            tableName: "aws_instances";
            dataType: "date";
            columnType: "PgTimestamp";
...
export declare const awsIntegrationsRelations: import("drizzle-orm").Relations<"aws_integrations", {
    organization: import("drizzle-orm").One<"organizations", true>;
    instances: import("drizzle-orm").Many<"aws_instances">;
}>;
export declare const awsInstancesRelations: import("drizzle-orm").Relations<"aws_instances", {
    integration: import("drizzle-orm").One<"aws_integrations", true>;
}>;
