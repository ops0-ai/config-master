...
-- Add RBAC permissions for Hive
INSERT INTO permissions (resource, action, description) VALUES
('hive', 'read', 'View hive agents and telemetry'),
('hive', 'create', 'Create and register new hive agents'),
('hive', 'update', 'Update hive agent configurations'),
('hive', 'delete', 'Delete hive agents'),
('hive', 'execute', 'Execute commands on hive agents'),
('hive', 'configure', 'Configure hive agent outputs and pipelines'),
('hive', 'read_telemetry', 'View telemetry data from hive agents')
ON CONFLICT (resource, action) DO NOTHING;

-- Grant all hive permissions to Administrator role
