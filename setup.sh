...
EOF
    ...
    # Create web .env file for frontend
    if [ ! -f "$SCRIPT_DIR/apps/web/.env" ]; then
        log "Creating web .env file..."
...
EOF
        log "✅ Created apps/web/.env file with server IP: $SERVER_IP"
    else
        log "✅ Using existing apps/web/.env file"
    fi
